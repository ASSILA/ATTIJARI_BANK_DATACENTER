package com.attijari.bank.technical;
	...
	public class SnmpGetExemple {
	
	  private static String  ipAddress  = "192.168.249.131";

	  private static String  port    = "8001";

	  // OID of MIB RFC 1213; Scalar Object = .iso.org.dod.internet.mgmt.mib-2.system.sysDescr.0
	  private static String  oidValue  = "1.3.6.1.2.1.7.1";  // ends with 0 for scalar object
