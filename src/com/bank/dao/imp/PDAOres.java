...
public class PDAOres implements PIDAO<Peripheralres> 
{
...
//description du périphériq
     {
        ...
        List <Interfaceres> description = new ArrayList();
        ...
        while (i.hasNext() && j.hasNext() && k.hasNext() && l.hasNext() && s.hasNext())
        {
            ...
            idd = (String) l.next();
            nn = (String) s.next();
            Interfaceres inter = new Interfaceres(a, b, nn,idb, b, idd);
   ...
   /**************************************************************************************************************/
    ...
    {
        PDAOres cd = new PDAOres();
        int st;
       //List st = new ArrayList();
       //String st;
        
       try {
		st = cd.SnmpGetNumberOfInterface("192.168.95.131");
